		...
		<SafeAreaView style={ { backgroundColor: "#E9E9E9", flex: 1 } }>
			<ScrollView style={ { flexDirection: "column" } }>
				<View style={ { padding: 20 } }>
					<Text style={ { marginTop: 20, marginBottom: 20, fontSize: 22, fontWeight: "600" } }>Ipsum</Text>
					...
					<Text>&emsp;&emsp;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur, doloribus enim
						...
						quis.</Text>
					<Text style={ { marginTop: 20, marginBottom: 20, fontSize: 22, fontWeight: "600" } }>Lorem</Text>
